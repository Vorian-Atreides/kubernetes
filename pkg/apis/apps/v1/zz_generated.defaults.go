...
func SetObjectDefaults_DaemonSet(in *v1.DaemonSet) {
	...
	for i := range in.Spec.Template.Spec.InitContainers {
		...
		if a.DownscalinessProbe != nil {
			corev1.SetDefaults_Probe(a.DownscalinessProbe)
			if a.DownscalinessProbe.Handler.HTTPGet != nil {
				corev1.SetDefaults_HTTPGetAction(a.DownscalinessProbe.Handler.HTTPGet)
			}
		}
		if a.Lifecycle != nil {
	...
	for i := range in.Spec.Template.Spec.EphemeralContainers {
		...
		if a.EphemeralContainerCommon.DownscalinessProbe != nil {
			corev1.SetDefaults_Probe(a.EphemeralContainerCommon.DownscalinessProbe)
			if a.EphemeralContainerCommon.DownscalinessProbe.Handler.HTTPGet != nil {
				corev1.SetDefaults_HTTPGetAction(a.EphemeralContainerCommon.DownscalinessProbe.Handler.HTTPGet)
			}
		}
