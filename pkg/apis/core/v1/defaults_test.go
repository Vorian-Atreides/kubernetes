...
func TestWorkloadDefaults(t *testing.T) {
	...
	expectedDefaults := map[string]string{
		...
		".Spec.Containers[0].DownscalinessProbe.FailureThreshold":       "3",
		".Spec.Containers[0].DownscalinessProbe.Handler.HTTPGet.Path":   `"/"`,
		".Spec.Containers[0].DownscalinessProbe.Handler.HTTPGet.Scheme": `"HTTP"`,
		".Spec.Containers[0].DownscalinessProbe.PeriodSeconds":          "10",
		".Spec.Containers[0].DownscalinessProbe.SuccessThreshold":       "1",
		".Spec.Containers[0].DownscalinessProbe.TimeoutSeconds":         "1",
		...
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.FailureThreshold":       "3",
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.Handler.HTTPGet.Path":   `"/"`,
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.Handler.HTTPGet.Scheme": `"HTTP"`,
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.PeriodSeconds":          "10",
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.SuccessThreshold":       "1",
		".Spec.EphemeralContainers[0].EphemeralContainerCommon.DownscalinessProbe.TimeoutSeconds":         "1",
		...
		".Spec.InitContainers[0].DownscalinessProbe.FailureThreshold":                                     "3",
		".Spec.InitContainers[0].DownscalinessProbe.Handler.HTTPGet.Path":                                 `"/"`,
		".Spec.InitContainers[0].DownscalinessProbe.Handler.HTTPGet.Scheme":                               `"HTTP"`,
		".Spec.InitContainers[0].DownscalinessProbe.PeriodSeconds":                                        "10",
		".Spec.InitContainers[0].DownscalinessProbe.SuccessThreshold":                                     "1",
		".Spec.InitContainers[0].DownscalinessProbe.TimeoutSeconds":                                       "1",
